...
//This is the page for upper body workouts where we can tab between beginner intermediate and advanced workouts and there will be videos for each
export default function UpperBody() {
    ...
    function getVideo(level,setVideoURL) {
        ...
        const listRef = ref(storage, 'workoutVideos/UpperBody/' + level)
            listAll(listRef)
                .then((res) => {
