...
//This is the page for cardio workouts where we can tab between beginner intermediate and advanced workouts and there will be videos for each
export default function Cardio() {
    ...
    function getVideo(level,setVideoURL) {
        ...
        const listRef = ref(storage, 'workoutVideos/Cardio/' + level)
            listAll(listRef)
                .then((res) => {
